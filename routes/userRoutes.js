...
const { registerUser, loginUser, logout, updateProfile, deleteProfile, getUserDetails, getAllUsers, updatePassword, updateUserRole, verifyEmail } = require('../controllers/userController');
